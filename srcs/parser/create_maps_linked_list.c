...
void	add_map_lists_back(t_map_cont_list **head, t_map_cont_list *will_add_node)
{
	t_map_cont_list	*traversal;
...
{
	t_map_cont_list	*new_node;
	
	new_node = malloc(sizeof(t_map_cont_list));
	if (!new_node)
		return (NULL);
